                        ...
                        <div className="card">
                          <div className="card-body p-6">
                                ...
                                <div className="invoice-address-company-fields">
                                  <div className="form-group">
                                    ...
                                    <input type="text"
                                                       ...
                                                       id="company-name" placeholder="Business Name" value="G5Themes" name="name" />
                                  </div>
                                  <div className="form-group">
                                    ...
                                    <input type="text"
                                                       ...
                                                       value="info@company.com" name="email" />
                                  </div>
                                  <div className="form-group">
                                    ...
                                    <input type="text"
                                                       ...
                                                       value="XYZ Delta Street" name="address" />
                                  </div>
                                  <div className="form-group">
                                ...
                                <div className="invoice-address-client-fields">
                                  <div className="form-group">
                                    ...
                                    <input type="text"
                                                       className="form-control border-0 shadow-none form-control-lg"
                                                       id="client-name"
                                                       placeholder="Client Name" value="Jesse Cory" name="client-name" />
                                  </div>
                                  <div className="form-group">
                                  ...
                                  <div className="form-group">
                                    ...
                                    <input type="text"
                                                       ...
                                                       value="405 Mulberry Rd. Mc Grady, NC, 28649" name="client-address" />
                                  </div>
                                  <div className="form-group">
                                    ...
                                    <input type="text"
                                                       ...
                                                       value="(128) 666 070" name="client-phone" />
                                  </div>
                                </div>
                              </div>
                            </div>
                              ...
                              <div className="col-md-4">
                                <div className="form-group mb-4">
                                  ...
                                  <input type="text"
                                                   className="form-control border-0 shadow-none form-control-lg"
                                                   id="number"
                                                   placeholder="#0001" value="#0001" name="invoice-number" />
                                </div>
                              </div>
                              <div className="col-md-4">
                                <div className="form-group mb-4">
                                  ...
                                  <input type="date"
                                                   ...
                                                   id="date" placeholder="Add date picker" name="available-from" value="2021-04-07" />
                                </div>
                              </div>
                              <div className="col-md-4">
                                <div className="form-group mb-4">
                                  ...
                                  <input type="date"
                                                   className="form-control form-control-lg border-0"
                                                   id="due" placeholder="None" name="available-to" value="2021-04-12" />
                                </div>
                              </div>
                            </div>
                            <div className="mb-6">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td className="description d-block d-md-table-cell w-100 w-md-auto"><input type="text"
                                                                                   ...
                                                                                   value="Calendar App Customization" name="description[]" />
                                      ...
                                      <td className="rate d-inline-block d-md-table-cell">
                                        <input type="text"
                                                               className="form-control border-0 shadow-none form-control-lg"
                                                               placeholder="Price" value="65" name="price[]" />
                                      </td>
                                      <td className="text-md-right qty d-inline-block d-md-table-cell"><input type="text"
                                                                                      className="form-control border-0 shadow-none form-control-lg"
                                                                                      placeholder="Quantity" value="1" name="quality[]" />
                                      </td>
                            ...
                            <div className="form-group">
                              ...
                              <textarea className="form-control border-0 shadow-none form-control-lg"
                                              id="invoice-detail-notes" name="note"
                                    ...
                                    <a className="dropdown-item d-flex" data-img-value="assets/img/flag-gbp.svg"
                                          ...
                                          <div className="invoice-action-tax-fields">
                                            <div className="form-group mb-0">
                                              ...
                                              <div className="dropdown selectable-dropdown invoice-tax-select no-caret">
                                               ...
                                               aria-haspopup="true" aria-expanded="false">
                                                  <span
                                                        className="selectable-text d-inline-block mr-auto text-truncate">On Total</span>
                                        ...
                                        <div className="invoice-action-discount mb-5">
                                          ...
                                          <div className="form-group mb-0">
                                           ...
                                           aria-haspopup="true" aria-expanded="false"> <span
                                                className="selectable-text d-inline-block mr-auto text-truncate">Flat Amount</span>
                                                <span><i className="fal fa-angle-down"></i></span>
                                              </a>
                                      ...
                                      <div className="invoice-actions-btn card card-body p-6">
                                       ...
                                       className="btn btn-secondary btn-preview btn-block btn-lg">Preview</a>
                                          ...
                                          <div>
                                            <button
                                            className="btn btn-success btn-download btn-block btn-lg">Save
                                            </button>
                                          </div>
                                        </div>
                                      </div>
...
export default SuperEditInvoice; 